    ...
    <ScrollView style={styles.maincontainer}>
      ...
      <View>
        ...
        <TouchableOpacity
          ...
          <Text style={{color: colors.black}}>Registered Services</Text>
        </TouchableOpacity>
        ...
        {searchTextInput().map(service => (
          <View key={service.id}>
            <TouchableOpacity
              onPress={() => {
                handleUserBasedOnService(service.title, service.id);
              }}>
      ...
      <View>
        <View>
          <TextInput
            style={{borderWidth: 1, margin: 10, color: colors.black}}
            onChangeText={text => setMobileOne(text)}
            value={mobileOne}></TextInput>
          <TextInput
            style={{borderWidth: 1, margin: 10, color: colors.black}}
            onChangeText={text => setMobileTwo(text)}
            value={mobiletwo}></TextInput>
          <TextInput
            style={{borderWidth: 1, margin: 10, color: colors.black}}
